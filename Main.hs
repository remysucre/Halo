...
happyReduction_6 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn4
		 (Bicond happy_var_2 happy_var_4
	) `HappyStk` happyRest
...
sentence tks = happyRunIdentity happySomeParser where
